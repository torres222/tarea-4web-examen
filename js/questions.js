...
// Recuperar datos del fichero XML xml/preguntas.xml
// xmlDOC es documento leido XML. 
function gestionarXml(dadesXml){
	var xmlDoc = dadesXml.responseXML; //XML a xmlDoc
	var tipo = "";
...
function imprimirTituloPregunta(i, xmlDoc){
	//pasa pregunta xml busca atributo title y lo lleva en <h3> en el html
...
//hace select multiple pueda aplicar sin Ctrl
